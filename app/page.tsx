...
export default function Home() {
  const TABS: ItemProps[] = [
    ...
    { id: "projects", title: "Proyectos" },
    {
      id: "contact",
      title: "Contacto",
      href: "mailto:klvelarde.dev@gmail.com",
    },
  ];
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (lastSectionId && lastSectionId != null && lastSectionId !== tabActive)
        setTabActive(lastSectionId);
    };
    ...
    //if (favicon) favicon.href = 'favicon-front.ico';
    ...
    <main className="m-[20px]">
      <header className="fixed right-0 w-full z-10 flex justify-center">
        <Navtab
          ...
          customClass={`${highlightMenu ? "bg-black/70" : "bg-transparent"}`}
        />
      </header>
      <main className="max-w-[790px] my-0 mx-auto">
        <section
          id="about"
          className="my-0 mx-auto pt-[100px] md:pt-[140px] pb-[70px] flex flex-col items-center justify-center md:justify-between max-w-[700px]"
        >
          <h3 className="text-5xl font-slackside text-retama text-center mb-0">
            Kelly Velarde
          </h3>
          <div className="font-mono	font-semibold bg-camelia text-sm text-white w-full text-center">
            software developer
          </div>
          <p className="my-4 text-center md:text-left">
            ¡Hola! Soy desarrolladora de software con más de 4 años de
            experiencia. Me considero una persona con iniciativa propia, siempre
            en busca de nuevos aprendizajes y de retroalimentaciones constantes.
            Soy positiva, responsable, capaz de trabajar en equipo y compartir
            mis conocimientos.
          </p>
          <div className="md:self-start flex flex-row items-center justify-center gap-[10px] flex-wrap">
            ...
            <Button tag="a" href="mailto:klvelarde.dev@gmail.com">
              ...
              >
                <path
                  d="M12.5 3H3.75C3.06062 3 2.5 3.56062 2.5 4.25V7.375H3.75V5.5L7.75 8.5C7.85823 8.58104 7.98979 8.62484 8.125 8.62484C8.26021 8.62484 8.39177 8.58104 8.5 8.5L12.5 5.5V11.125H7.5V12.375H12.5C13.1894 12.375 13.75 11.8144 13.75 11.125V4.25C13.75 3.56062 13.1894 3 12.5 3ZM8.125 7.21875L4.16625 4.25H12.0837L8.125 7.21875Z"
                  fill="currentColor"
                />
                <path
                  d="M1.25 8H5.625V9.25H1.25V8ZM2.5 9.875H6.25V11.125H2.5V9.875ZM4.375 11.75H6.875V13H4.375V11.75Z"
                  fill="currentColor"
                />
              </svg>
              Contáctame
        ...
        <section id="experience" className="py-[70px]">
          <Typography
            tag="h3"
            customClass="flex flex-row items-center gap-[5px]"
          >
            <svg
              className="size-6"
              width="18"
            ...
            {PROJECTS.map((project, index) => (
              ...
              >
                <div className="flex flex-col grow">
                  <Typography tag="h4" customClass="text-camelia mb-2">
                    {project.title}
                  </Typography>
